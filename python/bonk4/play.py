...
Player 2 (red) is idle by default, or driven from a training checkpoint:
  ...
  python -m bonk4.play --checkpoint CKPT.json                   # you vs main
  python -m bonk4.play --checkpoint CKPT.json --opponent exp:3  # you vs exploiter #3
  python -m bonk4.play --checkpoint CKPT.json --auto --opponent snap:0
