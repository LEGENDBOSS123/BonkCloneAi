...
class League:
    ...
    def start_exploiter(self):
        ...
        self.exp_is_staller = (np.random.random() < C.EXPLOITER_STALLER_PROB)
    ...
    def _freeze(self, src_net, device="cpu"):
        ...
        device."""
        # Match the actor's real output width (action + duration heads packed).
        net = MLP(self.agent.state_dim, C.HIDDEN, src_net.out.out_features)
